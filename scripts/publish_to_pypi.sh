...
publish_package "packages/fustor-core" "fustor-core"

# --- Phase 2: Clients & Basic Connectors ---
echo "--- Phase 2: Publishing Clients & Basic Connectors ---"

publish_package "packages/sender-echo" "fustor-sender-echo"
publish_package "packages/sender-openapi" "fustor-sender-openapi"
...
publish_package "packages/fustor-source-oss" "fustor-source-oss"
publish_package "packages/fustor-view-fs" "fustor-view-fs"
publish_package "packages/fustor-schema-fs" "fustor-schema-fs"

# --- Phase 3: SDKs & Advanced Connectors ---
echo "--- Phase 3: Publishing SDKs & Advanced Connectors ---"
publish_package "packages/fustor-source-fs" "fustor-source-fs"
publish_package "packages/fustor-fusion-sdk" "fustor-fusion-sdk"
publish_package "packages/fustor-agent-sdk" "fustor-agent-sdk"
publish_package "packages/demo" "fustor-demo"
publish_package "packages/fustor-sender-http" "fustor-sender-http"
publish_package "packages/fustor-receiver-http" "fustor-receiver-http"
