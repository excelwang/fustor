...
pub const ROUTE_TOKEN_MYSQL_SOURCE_INTERNAL: &str = "mysql-source.internal";
pub const METHOD_FETCH: &str = "fetch";
pub const METHOD_STATUS: &str = "status";

pub const ROUTE_KEY_FETCH_INTERNAL: &str = "mysql-source.fetch:v1";
pub const ROUTE_KEY_STATUS_INTERNAL: &str = "mysql-source.status:v1";
...
mod tests {
    ...
    fn route_key_is_scoped_by_node_id() {
        assert_eq!(
            ...
            "mysql-source.fetch.node_a_1:v1.req"
        );
    }
}
