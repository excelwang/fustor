...
from it.fixtures.constants import MOUNT_POINT
from it.conftest import CONTAINER_CLIENT_A
from it.utils import docker_manager

logger = logging.getLogger("fustor_test")

class TestDebugTree:
    def test_dump_tree(self, docker_env, fusion_client, setup_agents):
        """Dump the full file tree to debug path issues."""
        
        # Create a file via Realtime (Agent A)
