...
class HTTPSender(Sender):
    ...
    async def heartbeat(self, can_realtime: bool = False, **kwargs) -> Dict[str, Any]:
        """
        ...
        try:
            result = await self.client.send_heartbeat(self.session_id, can_realtime=can_realtime, **kwargs)
