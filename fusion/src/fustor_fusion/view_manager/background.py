...
class BackgroundTaskStatus:
    ...
    def update_status(self, view_id: str, task_name: str, status: str, details: Optional[Dict[str, Any]] = None):
    ...
    def get_status(self, view_id: str, task_name: str = None):
...
async def get_background_task_status(view_id: str = None, task_name: str = None):
    """
...
async def process_view_events_loop(view_id: str):
    """
