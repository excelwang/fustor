...
diff --git a/fs-meta/docs/DEPLOYMENT_ENGINEER_MANUAL.md b/fs-meta/docs/DEPLOYMENT_ENGINEER_MANUAL.md
new file mode 100644
index 0000000..f423d23
--- /dev/null
+++ b/fs-meta/docs/DEPLOYMENT_ENGINEER_MANUAL.md
@@ -0,0 +1,490 @@
+# fs-meta 部署工程师手册
+
...
+
+如果本次环境采用 5 台业务节点，则运行组件由现场本地环境变量指定：
+
+- `FSMETA_DEMO_HOST_1`
+- `FSMETA_DEMO_HOST_2`
+- `FSMETA_DEMO_HOST_3`
