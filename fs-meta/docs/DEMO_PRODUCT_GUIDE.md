...
diff --git a/fs-meta/docs/DEMO_PRODUCT_GUIDE.md b/fs-meta/docs/DEMO_PRODUCT_GUIDE.md
new file mode 100644
index 0000000..5fd5fcb
--- /dev/null
+++ b/fs-meta/docs/DEMO_PRODUCT_GUIDE.md
@@ -0,0 +1,302 @@
+# fs-meta Demo 产品说明书
+
...
+
+如果本次 demo 采用 5 节点环境，则运行组件由本地环境变量 `FSMETA_DEMO_HOST_1..5` 指定。
