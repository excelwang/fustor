...
| 5 | `operations-real-nfs` | 5-node / 5-NFS full demo validation environment | Failover, resource switch, retire, activation-scope capture, release upgrade, and CPU budget. |
...
| `operations-real-nfs` | `fs_meta_operations_*_real_nfs` plus ignored runtime component diagnostics. |
