...
# Copy this file to an untracked local env file such as:
#   fs-meta/docs/examples/demo-env.local.sh
# Then fill values for the target environment and source it before L4/L5 runs.
#
# Keep real hosts, users, mount paths, tokens, rendered roots files, and
# temporary deployment paths out of git.
