...
diff --git a/fs-meta/docs/examples/demo-aggregate-10e8.sh b/fs-meta/docs/examples/demo-aggregate-10e8.sh
new file mode 100755
index 0000000..9c1af98
--- /dev/null
+++ b/fs-meta/docs/examples/demo-aggregate-10e8.sh
@@ -0,0 +1,47 @@
+#!/usr/bin/env bash
+set -euo pipefail
+
