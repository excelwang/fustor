...
1. **持续推进**: 在重构过程中持续工作，直到 `.agent/artifacts/` 中的review文档描述的所有方案或问题都已实现或修复。
2. **自主执行**: 在重构工作期间**不要**停下来询问用户，除非遇到歧义或需要澄清的关键设计决策。
